                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="first_name" class="form-control" type="text" value="{{ $employee->first_name }}" required>
                                            @error('first_name')
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input name="last_name" class="form-control" type="text" value="{{ $employee->last_name }}" required>
                                            @error('last_name')
                                            <p style="color: red"> {{ $message }} </p>
                                            <br>
                                            @enderror										</div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobile_number" type="number" value="{{ $employee->mobile_number }}" required>
                                            @error('mobile_number')
                                            <p style="color: red"> {{ $message }} </p>
                                            <br>
                                            @enderror										</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="job_id" class="select">
                                                ...
                                                @foreach($jobs as $job)
                                                    <option {{ $employee->job->name == $job->name? 'selected' : '' }} value="{{ $job->id }}">{{ $job->name}}</option>
                                                @endforeach
                                            </select>
                                            @error('job_id')
                                            <p style="color: red"> {{ $message }} </p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_admin" class="select">
                                                ...
                                                <option {{ $employee->is_admin == 1 ? 'selected' : '' }} value="{{ 1 }}">Admin</option>
                                                <option {{ $employee->is_admin == 0 ? 'selected' : '' }} value="{{ 0 }}">Employee</option>
                                            </select>
                                            @error('is_admin')
                                            <p style="color: red"> {{ $message }} </p>
                                            <br>
