						...
						<div class="col-md-6 offset-md-2">
                            ...
                            <form method="post" action="{{route('admin.jobs.update' , $job->id)}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" class="form-control" type="text" value="{{ $job->name }}" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="department_id" class="select" required>
                                        ...
                                        @foreach($departments as $department)
                                            <option {{ $job->department->id == $department->id ? 'selected' : '' }} value="{{ $department->id }}">{{ $department->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('department_id')
                                    <p style="color: red"> {{ $message }} </p>
