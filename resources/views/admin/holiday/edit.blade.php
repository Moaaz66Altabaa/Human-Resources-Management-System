				...
				<div class="content container-fluid">
					<div class="row">
						<div class="col-md-8 offset-md-2">
                            ...
                            <form method="post" action="{{route('admin.holiday.update' , $holiday->id)}}">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" class="form-control" type="text" value="{{ $holiday->name }}" required>
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="from" class="form-control" type="date" value="{{ $holiday->from }}" required>
                                    @error('from')
                                    <p style="color: red"> {{ $message }} </p>
                                    <br>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="to" class="form-control" type="date" value="{{ $holiday->to }}" required>
                                    @error('to')
                                    <p style="color: red"> {{ $message }} </p>
                                    <br>
                                    @enderror								</div>
