		...
		<div class="header">
			...
			<div class="header-left">
				<a href="index.html" class="logo">
					<img src="/assets/img/HR_Logo.png" width="40" height="40" alt="">
				</a>
			</div>
			<!-- /Logo -->
			...
			<ul class="nav user-menu">
                        ...
                        <div class="noti-content">
                            <ul class="notification-list">
                                ...
                                <div class="topnav-dropdown-footer">
                                    <a href="{{ route('employee.activite.index') }}">View all Notifications</a>
                                </div>
                        </div>
				</li>
				<!-- /Notifications -->
				...
				<li class="nav-item dropdown has-arrow main-drop">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="{{ route('employee.employee.profile') }}">My Profile</a>
